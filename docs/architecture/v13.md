# Budget & Ledger – Architecture Reference - Version 13 (Authoritative)

This document defines the conceptual architecture (meaning, structure, and intent) of the Budget & Ledger system.  
It does **not** define formulas, automation, or styling.
...
5. **Judgment Is Central**  
   No automated decision-making rules. Human allocation decisions are required.
...
- Final balances must reconcile to cash at month close.  
  This is a required system invariant and is enforced structurally.
...
### 9.4 Unassigned
- Allowed mid-month
- Unassigned must be zero at month close.  
  This is a required closing invariant of the system.
